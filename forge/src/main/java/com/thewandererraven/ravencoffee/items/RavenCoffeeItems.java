...
public class RavenCoffeeItems {
    ...
    public static final RegistryObject<Item> COFFEE_CHERRIES = ITEMS.register(
            ...
            () -> new ItemNameBlockItem(
                    ...
                    new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB)
            )
    );
    ...
    public static final RegistryObject<Item> CUP_SMALL_UNFIRED = ITEMS.register(
            "cup_small_unfired",
            () -> new ItemBase(RavenCoffeeForge.CUP_SMALL_TAB)
    );
    ...
    public static final RegistryObject<Item> CUP_MEDIUM_UNFIRED = ITEMS.register(
            "cup_medium_unfired",
            () -> new ItemBase(RavenCoffeeForge.CUP_MEDIUM_TAB)
    );
    ...
    public static final RegistryObject<Item> CUP_LARGE_UNFIRED = ITEMS.register(
            "cup_large_unfired",
            () -> new ItemBase(RavenCoffeeForge.CUP_LARGE_TAB)
    );
    ...
    public static final RegistryObject<Item> COFFEE_PICKAXE = ITEMS.register(
            "coffee_pickaxe",
            () -> new PickaxeItem(RavenCoffeeItemTier.COFFEE, 3, -2.8f, new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> COFFEE_AXE =  ITEMS.register(
            "coffee_axe",
            () -> new AxeItem(RavenCoffeeItemTier.COFFEE, 8, -2.7f, new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> COFFEE_HOE =  ITEMS.register(
            "coffee_hoe",
            () -> new HoeItem(RavenCoffeeItemTier.COFFEE, 0, 1.0f, new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> COFFEE_SHOVEL =  ITEMS.register(
            "coffee_shovel",
            () -> new ShovelItem(RavenCoffeeItemTier.COFFEE, 4, -3.0f, new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> COFFEE_SWORD =  ITEMS.register(
            "coffee_sword",
            () -> new SwordItem(RavenCoffeeItemTier.COFFEE, 5, -2.0f, new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );

    // ############################################### COFFEE BLOCK ITEMS ################################################
    public static final RegistryObject<Item> BROWNIE_BLOCK_ITEM = ITEMS.register(
            "brownie_block",
            () -> new BlockItem(RavenCoffeeBlocks.BROWNIE_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB)
                    .food(new FoodProperties.Builder()
                            .nutrition(20)
                            .saturationMod(1.0f)
    ...
    public static final RegistryObject<Item> ROSCA_DE_REYES_BLOCK_ITEM = ITEMS.register(
            ...
            () -> new BlockItem(RavenCoffeeBlocks.ROSCA_DE_REYES_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> TIRAMISU_BLOCK_ITEM = ITEMS.register(
            "tiramisu_block",
            () -> new BlockItem(RavenCoffeeBlocks.TIRAMISU_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> COFFEE_BEANS_ROASTED_BLOCK_ITEM = ITEMS.register(
            "coffee_beans_roasted_block",
            () -> new BlockItem(RavenCoffeeBlocks.COFFEE_BEANS_ROASTED_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
    public static final RegistryObject<Item> COFFEE_BEANS_MAGMA_BLOCK_ITEM = ITEMS.register(
            "coffee_beans_magma_block",
            () -> new BlockItem(RavenCoffeeBlocks.COFFEE_BEANS_MAGMA_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );

    public static final RegistryObject<Item> COFFEE_GRINDER_ITEM = ITEMS.register(
            "coffee_grinder_block",
            () -> new BlockItem(RavenCoffeeBlocks.COFFEE_GRINDER.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );

    public static final RegistryObject<Item> COFFEE_MACHINE_ITEM = ITEMS.register(
            "coffee_machine_block",
            () -> new BlockItem(RavenCoffeeBlocks.COFFEE_MACHINE_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );

    public static final RegistryObject<Item> SACK_BLOCK_ITEM = ITEMS.register(
            "sack_block",
            () -> new BlockItem(RavenCoffeeBlocks.SACK_BLOCK.get(), new Item.Properties().tab(RavenCoffeeForge.GENERAL_TAB))
    );
}
