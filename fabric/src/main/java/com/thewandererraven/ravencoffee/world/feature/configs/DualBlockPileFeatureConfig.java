package com.thewandererraven.ravencoffee.world.feature.configs;
...
public class DualBlockPileFeatureConfig implements FeatureConfig {
    public static final Codec<DualBlockPileFeatureConfig> CODEC = RecordCodecBuilder.create((p_236589_0_) -> p_236589_0_.group(BlockStateProvider.TYPE_CODEC.fieldOf("trunk_state_provider").forGetter((p_236599_0_) -> {
        return p_236599_0_.trunkStateProvider;
    }), BlockStateProvider.TYPE_CODEC.fieldOf("leaves_state_provider").forGetter((p_236599_0_) -> {
